  ...
  return (
    <Wrapper>
      <Flow classNames="group">
        <div className="ring-4 ring-amethyst-600 ring-offset-4 ring-offset-neutral-white rounded-sm transition-transform transform hover:translate-x-1/2 test placeholder-persimmon-100::-webkit-input-placeholder bg-primary px-tiny sm:px-5 m--1" data-variant={variant}>{children}</div>
